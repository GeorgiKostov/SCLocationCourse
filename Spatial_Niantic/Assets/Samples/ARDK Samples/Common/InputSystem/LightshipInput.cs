...
//     version 1.8.2
//     from Assets/Samples/ARDK Samples/Common/InputSystem/LightshipInput.inputactions
//
...
public partial class @LightshipInput: IInputActionCollection2, IDisposable
{
    ...
    ~@LightshipInput()
    {
        Debug.Assert(!m_Input.enabled, "This will cause a leak and performance issues, LightshipInput.Input.Disable() has not been called.");
    }
